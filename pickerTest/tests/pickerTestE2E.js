(function () {
	'use strict';
	angular.module('app').controller('PickerTestControllerE2E', PickerTestControllerE2E);

	PickerTestControllerE2E.$inject = ['$q', '$timeout', 'mx.internationalization', '$scope'];

	function PickerTestControllerE2E($q, $timeout, internationalization, $scope) {
		var vm = this;
		vm.readOnly = true;
		vm.isDisabled = true;
		...
		vm.pickerSelectedItem = vm.pickerItems[0].DisplayString;
