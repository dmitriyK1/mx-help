(function () {
	...
	angular.module('app').controller('MultiPickerControllerE2E', MultiPickerControllerE2E);

	MultiPickerControllerE2E.$inject = ['$q'];

	function MultiPickerControllerE2E($q) {
		var vm = this;
		...
		vm.browseLookup = function () {
			return confirm('Add items?') ? $q.when([vm.pickerData[2], vm.pickerData[4]]) : $q.when();
		};
	}
